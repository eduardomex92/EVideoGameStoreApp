    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DeveloperPublisher", x => new { x.DeveloperId, x.PublisherId });
                    table.ForeignKey(
                        name: "FK_DeveloperPublisher_Developers_DeveloperId",
                        column: x => x.DeveloperId,
                        principalTable: "Developers",
                        principalColumn: "DeveloperId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DeveloperPublisher_Publishers_PublisherId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    VideoGameCategory = table.Column<int>(type: "int", nullable: false),
                    DeveloperId = table.Column<int>(type: "int", nullable: false),
                    PublisherId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VideoGamePlatforms", x => new { x.VideoGameId, x.PlatformId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeveloperPublisher_PublisherId",
                table: "DeveloperPublisher",
                column: "PublisherId");
